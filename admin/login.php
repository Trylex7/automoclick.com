...
<body class="min-h-screen flex items-center justify-center p-4">
    <form method="POST" class="bg-white w-full max-w-md rounded-2xl shadow-lg p-6 space-y-6 border border-green-100">
        ...
        <div>
            ...
            <input id="id" type="email" name="identifiant" placeholder="Identifiant" value="<?php if (isset($identifiant))
                echo $identifiant; ?>"
