            ...
            <div class="max-w-7xl mx-auto flex justify-between items-center p-4 md:p-6 bg-white rounded-lg shadow">
                ...
                <div class="relative" @click.outside="openDropdown = false">
                    ...
                    <div x-show="openDropdown" x-transition
                        ...
                        <a href="#" class="flex items-center px-4 py-2 text-sm text-red-600 hover:bg-red-100">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        ...
                                        <button @click="deleteItem('produits', <?php echo $produit['id'] ?? 0; ?>)" class="text-red-600 hover:text-red-900">
            ...
            <div class="mt-3">
                ...
                <form @submit.prevent="saveItem('admins')">
                    ...
                    <div class="mb-4" x-show="!editingId">
                        ...
                        <input type="password" x-model="formData.password" required class="w-full px-3 py-2 border border-gray-300 rounded-md">
                    </div>
                    <div class="mb-4">
